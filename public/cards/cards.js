...
const HONEYCARD = document.getElementById("HONEY").appendChild(HONEY);
...
const Extraterrestrialcode = document
  .getElementById("ExtraterrestrialCode")
  .appendChild(ExtraterrestrialCode);
...
const AlienDreamtime = document
  .getElementById("AlienDreamTime")
  .appendChild(AlienDreamTime);
...
const SHARKSANDMINNOWS = document
