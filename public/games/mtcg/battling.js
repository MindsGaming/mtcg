function battling() {
  var MTCGid = document.getElementId("MTCG");
  var DooBetterid = document.getElementId("DooBetter");
  var StarShatterid = document.getElementId("StarShatter");
  var Lokayaid = document.getElementId("Lokaya");
  var GameTestPlayid = document.getElementId("GameTestPlay");
  var Cagedid = document.getElementId("Caged");
  var Yorizzoid = document.getElementId("Yorizzo");
  var Eclipseid = document.getElementId("Eclipse");
  var Pajuniorid = document.getElementId("Pajunior");
  var AlienShipid = document.getElementId("AlienShip");
  var InvaderGamingid = document.getElementId("mtcg");
  var Grockid = "grock";
