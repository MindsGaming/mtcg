...
const minutesLabel = document.getElementById("timeM");
const secondsLabel = document.getElementById("timeS");
...
function claimUpdate() {
  if (dreamInput.value == "") {
    ...
    if (minutesLabel.innerHTML == "00") {
      ...
      var REWARDS = PRIZE.value + "." + secondsLabel.innerHTML;
      const data = {
        dream:
          dreamInput.value +
          " " +
...
function reset() {
  var zero = "00";
  document.getElementById("timeM").innerHTML = zero;
  document.getElementById("timeS").innerHTML = zero;
  document.getElementById("prize").innerHTML = zero;
  document.getElementById("PRIZE").value = zero;
  totalSeconds = "0";
}
