...
function DEALCARDS() {
  ...
  if (inHand.value == "5") {
    ...
    var CARD1 = dealCARDS[Math.floor(Math.random() * dealCARDS.length)];
    var CARD2 = dealCARDS[Math.floor(Math.random() * dealCARDS.length)];
    var CARD3 = dealCARDS[Math.floor(Math.random() * dealCARDS.length)];

    document.getElementById("playerCads").appendChild(CARD1);
    document.getElementById("playerCads").appendChild(CARD2);
    document.getElementById("playerCads").appendChild(CARD3);

    var boost = 1;
    var addcard = inHand.value;
    var math = boost + addcard;
    inHand.value = math;
  }
}
