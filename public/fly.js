...
function quickhub() {
  ...
  if (dreamInput.value == "") {
    ...
    const data = {
      dream: dreamInput.value + " Joined Hubs",
    };
    ...
    dreams.push(dreamInput.value + " Joined Hubs");
    appendNewDream(dreamInput.value + " Joined Hubs");
  }
}
...
function viewgames() {
  ...
  if (dreamInput.value == "") {
    ...
    const data = {
      dream: dreamInput.value + " Is Playing Games",
    };
    ...
    // get dream value and add it to the list
    dreams.push(dreamInput.value + " Is Playing Games");
    appendNewDream(dreamInput.value + " Is Playing Games");
  }
}
